                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="member" items="${memlist.rows}">
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-default btn-xs" href="showProfile.jsp?id=${member.member_id}" target="_blank"><i class="fa fa-info-circle"></i></a>
                                                            <a class="btn btn-default btn-xs" href="editProfile.jsp?id=${member.member_id}" target="_blank"><i class="fa fa-wrench"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                        </table>
