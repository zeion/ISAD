                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                                ...
                                <div class="box-body" id="printableArea">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <dt>ชื่อ :</dt>
                                            <dd>${mem.rows[0].member_firstname}</dd>

                                            <dt>นามสกุล :</dt>
                                            <dd>${mem.rows[0].member_lastname}</dd>

                                            <dt>ชื่อเล่น :</dt>
                                            <dd>${mem.rows[0].member_nickname}</dd>
                                            ...
                                            <dt>การศึกษา :</dt>
                                            <dd>${mem.rows[0].member_edu}</dd>

                                            <dt>อาชีพ :</dt>
                                            <dd>${mem.rows[0].member_job}</dd>

                                            <dt>E-mail :</dt>
                                            <dd>${mem.rows[0].member_email}</dd>

                                            <dt>ที่อยู่ :</dt>
                                            <dd>345/6 ต.บางพระ อ.เมือง จ.ลพบุรี 1234</dd>

                                            <dt>จังหวัด :</dt>
                                            <dd>${mem.rows[0].member_province}</dd>
                                        </dl>                 
                                    </div>
                                </div><!-- /.box-body -->       
                            </div><!-- /.box -->
                            ...
                            <a class="btn btn-default pull-right" href="listMemReport.jsp">ยกเลิก</a>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </section><!-- /.content -->
            </div><!-- /.content-wrapper -->
