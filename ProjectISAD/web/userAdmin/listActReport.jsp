                  ...
                  <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-primary box-success">
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="radio" name="act" class="flat-red" value="1" checked/></td>
                                                    <td>หมิงเต้าปัน1</td>
                                                    
                                                    <td>เป็นกิจกรรมที่จัดขึ้นสำหรับผู้ที่เข้ามาสถานธรรมครั้งแรกโดยจะมีการอธิบายถึงสถานธรรมเรา</td>                                  
                                                </tr>
                                                <tr>
                                                    <td><input type="radio" name="act" class="flat-red" value="1"/></td>
                                                    <td>หมิงเต้าปัน2</td>
                              ...
                              <a class="btn btn-primary pull-right" href="printReport.html">จัดทำรายงาน</a>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </section><!-- /.content -->
            </div><!-- /.content-wrapper -->
